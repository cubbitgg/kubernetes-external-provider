module github.com/cubbitgg/kubernetes-external-provider/tests/e2e
...
replace github.com/kudobuilder/kuttl => github.com/cubbit/kuttl v0.22.0-allow-disable-parallel
